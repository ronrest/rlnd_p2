...
class MultiAgent():
    def __init__(self, state_size, action_size, n_agents=1, seed=42):
        ...
        """
        self.steps = 0  # keeps track of how many steps have been taken
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        # SAMPLE FROM EXPERIENCE BUFFER AND PERFORM LEARNING
